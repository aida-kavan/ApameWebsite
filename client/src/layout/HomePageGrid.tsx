...
import Sodinoimg from '/images/sodino-img.png';
import DefaultSlider from "@/components/elements/BannerSlider/DefaultSlider";
import PrintSlider from "@/components/elements/BannerSlider/PrintSlider";
import WebSeoSlider from "@/components/elements/BannerSlider/WebSeoSlider";
import { FaArrowLeft, FaArrowRight } from "react-icons/fa";
import { AnimatePresence, easeInOut, motion } from 'framer-motion';
import Trackt from '/images/tract.gif';
import PacketName from '/images/packetname.gif';
import SarBarg from '/images/sarbarg.gif';
import BoxGif from '/images/box.gif'
import VisitCard from '/images/card.gif';
import Label from '/images/label.gif';
...
function Home() {
  ...
  return (
    <section className="w-[85%] h-[83vh] rounded-3xl  z-10 ">
