...
const LoginPage = () => {
  ...
  return (
    <>
      ...
      <motion.div
        className="   flex items-center justify-evenly w-[900px] bg-cover rounded-4xl  p-2"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        exit={{ opacity: 0 }}
      >
        <div className="bg-white   w-[350px] gap-2 m-2 min-h-[300px] rounded-3xl flex  p-4 flex-col">
          {/* login form  */}
          <form
          ...
          >
            ...
            <div className="flex items-center mb-[-5px] gap-1 ">
              <Star fill="blue" stroke="0" size={12} />
              <label className="text-sm peydaThin ">نام کامل </label>
            </div>
            <Input
            ...
            <div className="flex items-center mb-[-5px] gap-1 ">
              <Star fill="blue" stroke="0" size={12} />
              <label className="text-sm peydaThin ">نام کاربری </label>
            </div>
            <Input
            ...
            <div className="flex items-center mb-[-5px] gap-1 ">
              <Star fill="blue" stroke="0" size={12} />
              <label className="text-sm peydaThin ">شماره تلفن </label>
            </div>
            <Input
             className={errors.userTel ? "border-red-500" : ""}
              placeholder="شماره تلفن را وارد کنید..."
              {...register("userTel", { required: true })}
            />
            <div className="flex items-center mb-[-5px] gap-1 ">
              <Star fill="blue" stroke="0" size={12} />
              <label className="text-sm peydaThin ">رمز عبور</label>
            </div>
            <Input
            ...
            <div className="flex items-center mb-[-5px] gap-1 ">
              <Star fill="blue" stroke="0" size={12} />
              <label className="text-sm peydaThin ">تائید رمز عبور </label>
            </div>
            <Input
             className={errors.userRePassword ? "border-red-500" : ""}
              placeholder="رمز عبور را تائید کنید..."
              {...register("userRePassword", { required: true })}
            />
            <div className="flex gap-1  ">
              <Checkbox onCheckedChange={() => setChecked(!checked)} />
              <p className="text-xs">با قوانین و شرایط مجموعه تبلیغاتی آپامه موافقت دارم.</p>
            </div>
            ...
            <Button
              ...
              !checked ||
              !(
                // useForm's watch method to check all fields
                (watch("fullName") &&
                watch("userName") &&
                watch("userTel") &&
                watch("userPassword") &&
                watch("userRePassword"))
              )
              }
            >
              ثبت نام
            ...
            {/* <div>
               <div className="flex gap-1 p-1  items-center  bg-gray-200 w-full h-10 rounded-md border">
